...
public class SQLTests {
    ...
    public void testTantargyQueries() {
        ...
        assertEquals("SELECT * FROM tantargy", generateListAllQuery(Tantargy.class));
    ...
    public void testKepzettsegQueries() {
        ...
        assertEquals("SELECT * FROM kepzettseg", generateListAllQuery(Kepzettseg.class));
    ...
    public void testTeremQueries() {
        ...
        assertEquals("SELECT * FROM terem", generateListAllQuery(Terem.class));
    ...
    public void testOsztalyQueries() {
        ...
        assertEquals("SELECT * FROM osztaly", generateListAllQuery(Osztaly.class));
    ...
    public void testTanarQueries() {
        ...
        assertEquals("SELECT tanar.*, kepzettseg.* FROM tanar INNER JOIN kepzettseg ON tanar.kepzettsegAzonosito = kepzettseg.azonosito", generateListAllQuery(Tanar.class));
    ...
    public void testDiakQueries() {
        ...
        assertEquals("SELECT diak.*, osztaly.* FROM diak INNER JOIN osztaly ON diak.osztalyAzonosito = osztaly.azonosito", generateListAllQuery(Diak.class));
